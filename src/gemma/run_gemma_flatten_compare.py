...
IREE_ROOT = ROOT.parent
STANDARD_SCRIPT = ROOT / "run_gemma_standard_iree.py"
REWRITE_SCRIPT = IREE_ROOT / "deepseek-R1-Llama-8b" / "rewrite_onnx_flatten_matmul.py"
INLINE_SCRIPT = IREE_ROOT / "deepseek-R1-Llama-8b" / "inline_onnx_dense_resources.py"
