module {
  func.func @main(%lhs: tensor<4x128x256xf32>,
    ...
    %0 = linalg.generic {
      ...
      } ins(%lhs, %rhs : tensor<4x128x256xf32>, tensor<256x256xf32>)
